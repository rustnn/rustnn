...
- Converter operator count: **70**
- Executor operator count: **70**
...
- `argMin`, `instanceNormalization`, `scatterElements`
- `averagePool2d`, `isInfinite`, `scatterND`
- `batchNormalization`, `isNaN`, `sigmoid`
- `cast`, `layerNormalization`, `sin`
- `clamp`, `leakyRelu`, `slice`
- `concat`, `lesser`, `softmax`
- `conv2d`, `lesserOrEqual`, `softplus`
- `convTranspose2d`, `linear`, `softsign`
- `cos`, `log`, `split`
- `dequantizeLinear`, `logicalAnd`, `sqrt`
- `div`, `logicalNot`, `squeeze`
- `elu`, `logicalOr`, `sub`
- `equal`, `logicalXor`, `tan`
- `exp`, `matmul`, `tanh`
- `expand`, `maxPool2d`, `tile`
- `gather`, `mul`, `transpose`
- `gatherElements`, `neg`, `triangular`
- `gatherND`, `notEqual`, `unsqueeze`
- `gelu`, `pad`, `where`
- `gemm`, `pow`
- `greater`, `prelu`
